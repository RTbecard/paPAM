...
================================
-run_paPAM_Mac_0_872.sh (shell script for temporarily setting environment variables and 
 executing the application)
   -to run the shell script, type
   
       ./run_paPAM_Mac_0_872.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/v81, run the shell script as:
       ...
       ./run_paPAM_Mac_0_872.sh /mathworks/home/application/v81
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_paPAM_Mac_0_872.sh /mathworks/devel/application/matlab
-MCRInstaller.zip 
   -if end users are unable to download the MCR using the above  
    link, include it when building your component by clicking 
    the "Add MCR" link in the Deployment Tool
-The Macintosh bundle directory structure paPAM_Mac_0_872.app 
   -this can be gathered up using the zip command 
    zip -r paPAM_Mac_0_872.zip paPAM_Mac_0_872.app
    or the tar command 
    tar -cvf paPAM_Mac_0_872.tar paPAM_Mac_0_872.app
-This readme file 
...
A. Mac systems:
   ...
   the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, it is possible 
              to run the shell script file run_paPAM_Mac_0_872.sh 
